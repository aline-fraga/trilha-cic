...
class ChamadoService:
    ...
    def criar(self, dados: ChamadoCreate, aluno_id: int):
        ...
        if any(c.aluno_id == aluno_id for c in chamados_abertos):
            raise HTTPException(
                status_code=400, detail="Você já possui um chamado em aberto. Aguarde a resposta antes de abrir outro."
            )
